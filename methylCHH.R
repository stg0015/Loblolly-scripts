...
RRBSobjs=processBismarkAln(location=RRBSfile.list
                           ...
                           save.folder="callfolderCHH",save.context="CHH",read.context="CHH",
...
write.csv(mat11, file= "matCHH10desfalse100.csv")
write.csv(meth11, file="methCHH10desfalse100.csv")
...
write.csv(mat12, file= "matCHH10desfalse90.csv")
write.csv(meth12, file="methCHH10desfalse90.csv")
...
write.csv(mat13, file= "matCHH10desfalse80.csv")
write.csv(meth13, file="methCHH10desfalse80.csv")
...
write.csv(mat14, file= "matCHH8desfalse100.csv")
write.csv(meth14, file="methCHH8desfalse100.csv")
...
write.csv(mat15, file= "matCHH8desfalse90.csv")
write.csv(meth15, file="methCHH8desfalse90.csv")
...
write.csv(mat16, file= "matCHH8desfalse80.csv")
write.csv(meth16, file="methCHH8desfalse80.csv")
...
write.csv(mat17, file= "matCHH5desfalse100.csv")
...
write.csv(mat18, file= "matCHH5desfalse90.csv")
write.csv(meth18, file="methCHH5desfalse90.csv")
...
write.csv(mat19, file= "matCHH5desfalse80.csv")
write.csv(meth19, file="methCHH5desfalse80.csv")
